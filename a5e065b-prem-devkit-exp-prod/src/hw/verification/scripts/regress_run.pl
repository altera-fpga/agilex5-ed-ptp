...
my $sender = 'lalshwet@ecsmtp.sc.intel.com';
my $receiver = 'shwetank.lal@altera.com alekhya.yerramreddy@altera.com ipsita.das@altera.com';
...
my $msg = MIME::Lite->new(
    ...
    To      => $receiver,
    #Cc      => $cc_receiver,
    Subject => "Regression results for SM PTP ED UVM simulations - Tool: $simulator",
  #  Data    => $msg_body,
