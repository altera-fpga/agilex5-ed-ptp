...
- Setup the Board Test System for Development on the host PC as mentioned in [Section 4.1](https://docs.altera.com/r/docs/814550/current/agilex-5-fpga-e-series-065b-premium-development-kit-user-guide/setting-up-the-quartus-prime-software-for-bts-operation) of Agilex&trade; 5 FPGA E-Series 065B Premium Development Kit User Guide.
- Open clock controller GUI fro SI5518A as mentioned in [Section 4.3.2.2](https://docs.altera.com/r/docs/814550/current/agilex-5-fpga-e-series-065b-premium-development-kit-user-guide/si5518-clock) of Agilex&trade; 5 FPGA E-Series 065B Premium Development Kit User Guide.
...
Please refer to the detailed documentation of the Design in Altera Developers site portal. Link to the Design documentation : [10GbE PTP1588 on Agilex 5E](https://altera-fpga.github.io/rel-26.1/embedded-designs/agilex-5/e-series/premium-065b/ptp1588/agx5e-ptp-2p10g/ug-agx5e-ptp-2p10g.md)
### Yocto Build
As described earlier, the Yocto builds everything required for a boot of the devkit with the deisgn. To start building please use the devkit specific script
	...
	All the required images are captured in the agilex5_dk_a5e065bb32aes1_b0-gsrd-images directory after a successfull build.
...
Download toolchain from https://developer.arm.com/-/media/Files/downloads/gnu/11.3.rel1/binrel/arm-gnu-toolchain-11.3.rel1-x86_64-aarch64-none-linux-gnu.tar.xz extract it.
    ...
    $ cd linux-socfpga/
    $ git checkout SED-2X10GE_PTP-agilex5_dk_a5e065bb32aes1-Q26.1-R1.1
    $ make defconfig
    $ make menuconfig
	...
	$ cp arch/arm64/boot/dts/intel/socfpga_agilex5_ptp_2p10g.dtb .
