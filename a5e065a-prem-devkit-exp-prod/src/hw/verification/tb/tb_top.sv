...
module tb_top ();
  ...
  qsfp_slave_interface    qsfp_slv_a0_if ( clk_100m, sm_ptp_reset_if.resetn);
  qsfp_slave_interface    qsfp_slv_a2_if ( clk_100m, sm_ptp_reset_if.resetn);
  ...
  // assign axi_if.slave_if[1].aresetn = `SM_PTP_SSGDMA_PATH.app_reset_status_n;
...
`endif
        ...
        .qsfp_i2c_scl          (scl_wand),
        .qsfp_i2c_sda          (sda_wand),
  ...
  (
        .clk                 (clk_100m),
        .address             (qsfp_slv_a0_if.address),
        .read                (qsfp_slv_a0_if.read),
        .readdata            (qsfp_slv_a0_if.readdata),
        .readdatavalid       (qsfp_slv_a0_if.readdatavalid),
        .waitrequest         (qsfp_slv_a0_if.waitrequest),
        .write               (qsfp_slv_a0_if.write),
        .byteenable          (qsfp_slv_a0_if.byteenable),
        .writedata           (qsfp_slv_a0_if.writedata),
  ...
  (
        .clk                 (clk_100m),
        .address             (qsfp_slv_a2_if.address),
        .read                (qsfp_slv_a2_if.read),
        .readdata            (qsfp_slv_a2_if.readdata),
        .readdatavalid       (qsfp_slv_a2_if.readdatavalid),
        .waitrequest         (qsfp_slv_a2_if.waitrequest),
        .write               (qsfp_slv_a2_if.write),
        .byteenable          (qsfp_slv_a2_if.byteenable),
        .writedata           (qsfp_slv_a2_if.writedata),
        .rst_n               (dut.iopll_locked_export_125M),
  ...
  //======================================================
    ...
    uvm_config_db#(virtual qsfp_slave_interface)::set(uvm_root::get(), "uvm_test_top.env.i2c_slv_env.qsfp_agent_a0", "vif", qsfp_slv_a0_if);
    uvm_config_db#(virtual qsfp_slave_interface)::set(uvm_root::get(), "uvm_test_top.env.i2c_slv_env.qsfp_agent_a2", "vif", qsfp_slv_a2_if);
