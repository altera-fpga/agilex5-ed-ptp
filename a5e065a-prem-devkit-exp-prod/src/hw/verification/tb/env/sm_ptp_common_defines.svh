...
`ifdef SM_PTP_CFG_25G  
  `ifndef SM_PTP_F2H_CLK
    `define SM_PTP_F2H_CLK dut.clk_bdg_180_clk
  `endif
`else
  `ifndef SM_PTP_F2H_CLK
    `define SM_PTP_F2H_CLK dut.clk_bdg_180_clk
...
`ifndef SM_PTP_HSSI_CSR_PORT0_PTP_P2P_DLY_0_ADDR
  `define SM_PTP_HSSI_CSR_PORT0_PTP_P2P_DLY_0_ADDR 'h4034_0000
`endif
...
`ifndef SM_PTP_HSSI_CSR_PORT0_PCS_RX
  `define SM_PTP_HSSI_CSR_PORT0_PCS_RX 'h4036_0000
`endif

`ifndef SM_PTP_PORT0_FEC_RX_CW_POS_ADDR_BASE
  `define SM_PTP_PORT0_FEC_RX_CW_POS_ADDR_BASE 'h4037_0000
`endif

`ifndef SM_PTP_PORT0_XCVRIF_RX_LAT_BIT_FOR_ASYNC_0_ADDR_BASE
  `define SM_PTP_PORT0_XCVRIF_RX_LAT_BIT_FOR_ASYNC_0_ADDR_BASE 'h403A_0000
`endif
...
`ifndef SM_PTP_HSSI_CSR_PORT1_PTP_P2P_DLY_0_ADDR
  `define SM_PTP_HSSI_CSR_PORT1_PTP_P2P_DLY_0_ADDR 'h4054_0000
`endif

`ifndef SM_PTP_HSSI_CSR_PORT1_HARD_IP_EMAC
  `define SM_PTP_HSSI_CSR_PORT1_HARD_IP_EMAC 'h4055_0000
`endif


`ifndef SM_PTP_HSSI_CSR_PORT1_PCS_RX
  `define SM_PTP_HSSI_CSR_PORT1_PCS_RX 'h4056_0000
`endif


`ifndef SM_PTP_PORT1_FEC_RX_CW_POS_ADDR_BASE
  `define SM_PTP_PORT1_FEC_RX_CW_POS_ADDR_BASE 'h4057_0000
`endif

`ifndef SM_PTP_PORT1_XCVRIF_RX_LAT_BIT_FOR_ASYNC_0_ADDR_BASE
  `define SM_PTP_PORT1_XCVRIF_RX_LAT_BIT_FOR_ASYNC_0_ADDR_BASE 'h405A_0000
`endif
...
parameter PLDIF_LANES       = 1;
parameter PL                = 1;
parameter  RATE        = "25G";        // Speed mode
parameter  FEC         = 2;    // FEC mode
parameter  XCVR        = 0;        // Transceiver type
parameter  is_var_undefined  = 3'd5;
parameter  is_var_xcvr100g   = 3'd4;
parameter  is_var_xcvr50g    = 3'd3;
parameter  is_var_xcvr25g_kp = 3'd2;
parameter  is_var_xcvr25g    = 3'd1;
parameter  is_var_xcvr10g    = 3'd0;
parameter  cw_pos_upper_bit  = 3'd5;
parameter tx_pma_delay_ui_fgt_50g    = 31'd63;
parameter tx_pma_delay_ui_fgt_10g25g = 31'd33;
parameter rx_pma_delay_ui_fgt_50g    = 31'd193;
parameter rx_pma_delay_ui_fgt_10g25g = 31'd96;
