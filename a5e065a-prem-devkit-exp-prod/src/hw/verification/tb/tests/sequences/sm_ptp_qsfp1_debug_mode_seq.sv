...
`ifndef SM_PTP_QSFP1_DEBUG_MODE_SEQ__SV
  `define SM_PTP_QSFP1_DEBUG_MODE_SEQ__SV

class sm_ptp_qsfp1_debug_mode_seq extends sm_ptp_qsfp_basic_seq;
  rand bit [`SVT_AXI_MAX_DATA_WIDTH-1:0] addr;
  `uvm_object_utils(sm_ptp_qsfp1_debug_mode_seq)

  // ----------------------------------------------------------------------
  // ----------------------------------------------------------------------
  function new(name = "sm_ptp_qsfp1_debug_mode_seq");
    super.new(name);
  endfunction: new
 // ----------------------------------------------------------------------
  // ----------------------------------------------------------------------
  ...
  endtask: body
endclass: sm_ptp_qsfp1_debug_mode_seq
