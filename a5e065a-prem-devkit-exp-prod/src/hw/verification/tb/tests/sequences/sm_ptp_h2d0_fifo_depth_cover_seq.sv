...
// dma port port 0 such that the Tx/Rx FIFO depth is exercised
...
`ifndef SM_PTP_H2D0_FIFO_DEPTH_COVER_SEQ__SV
`define SM_PTP_H2D0_FIFO_DEPTH_COVER_SEQ__SV

class sm_ptp_h2d0_fifo_depth_cover_seq extends sm_ptp_basic_seq;


  `uvm_object_utils(sm_ptp_h2d0_fifo_depth_cover_seq)

  sm_ptp_basic_data_path_seq     seq_h;

  // ----------------------------------------------------------------------
  // ----------------------------------------------------------------------
  function new(name = "sm_ptp_h2d0_fifo_depth_cover_seq");
    super.new(name);
  endfunction: new
...
`endif
  ...
  endtask: body
endclass: sm_ptp_h2d0_fifo_depth_cover_seq

`endif // SM_PTP_H2D0_FIFO_DEPTH_COVER_SEQ__SV
