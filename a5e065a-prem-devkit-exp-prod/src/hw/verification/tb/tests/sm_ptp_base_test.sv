...
class sm_ptp_base_test extends uvm_test;
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_slv_env.qsfp_agent_a0.sequencer.run_phase", "default_sequence", qsfp_slave_auto_response_sequence::type_id::get());
    uvm_config_db#(uvm_object_wrapper)::set(this, "env.i2c_slv_env.qsfp_agent_a2.sequencer.run_phase", "default_sequence", qsfp_slave_auto_response_sequence::type_id::get());
